...
export const ENV_DEFS = [
  ...
  },
  {
    ...
    group: 'twilight_bot',
    label: 'Paper mode',
    help: '1 = simulate trades (default). 0 = live. No real orders are sent in paper mode.',
    type: 'text',
  },
  {
    ...
    help: 'Must be YES to allow real orders when PAPER=0.',
    type: 'text',
  },
  {
  ...
  },
  {
    ...
    help: 'Maximum simultaneous open trades across all venues.',
    type: 'text',
  },
  {
    key: 'MAX_NOTIONAL_USD_PER_INTENT',
    group: 'twilight_bot',
    label: 'Max notional per trade (USD)',
    help: 'USD cap per single trade intent.',
    type: 'text',
  },
  {
    key: 'MAX_LEVERAGE',
    group: 'twilight_bot',
    label: 'Max leverage',
    help: 'Bot will not open positions requiring higher leverage than this.',
    type: 'text',
  },
  {
    key: 'DAILY_LOSS_STOP_USD',
    group: 'twilight_bot',
    label: 'Daily loss stop (USD)',
    help: 'Bot halts trading for the day once realized losses exceed this. Resets midnight UTC.',
    type: 'text',
  },
  {
    key: 'MIN_BALANCE_USD_PER_VENUE',
    group: 'twilight_bot',
    label: 'Min balance per venue (USD)',
    help: 'Bot will not open new positions on a venue below this available balance.',
    type: 'text',
  },
];
